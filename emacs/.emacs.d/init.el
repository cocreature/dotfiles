...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit-svn tuareg smartparens racket-mode bison-mode writeroom-mode systemd keyfreq rainbow-delimiters ensime mmm-mode lua-mode f dash-functional pdf-tools dockerfile-mode cmake-mode gnuplot jonprl-mode llvm-mode sml-mode toml-mode rust-mode clang-format nyan-mode nginx-mode yaml-mode web-mode json-mode company-coq ledger-mode unbound markdown-mode multiple-cursors which-key volume hydra prop-menu pkgbuild-mode yasnippet flycheck-package flycheck elisp-slime-nav auctex ace-window expand-region web libmpdee smart-mode-line moe-theme projectile magit magit-popup company-cmake company ws-butler undo-tree pos-tip ivy-hydra counsel swiper use-package)))
